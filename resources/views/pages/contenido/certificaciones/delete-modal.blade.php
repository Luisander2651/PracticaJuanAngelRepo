<div id="certifications-delete-modal" data-certifications-delete-modal class="fixed inset-0 z-100 hidden items-center justify-center bg-slate-900/50 p-4">
    <div class="w-full max-w-md rounded-[1.75rem] border border-slate-200 bg-white shadow-xl">
        <div class="border-b border-slate-200 px-6 py-5">
            ...
            <h3 class="mt-2 text-lg font-semibold text-slate-900">Eliminar certificacion</h3>
        </div>

        <form data-certifications-delete-form class="space-y-4 px-6 py-5">
            <input type="hidden" data-certifications-delete-id name="id" />

            <div class="rounded-2xl border border-red-200 bg-red-50 p-4">
                <p class="text-sm leading-6 text-red-800">
                    Esta accion eliminara la certificacion
                    <span data-certifications-delete-target class="font-semibold text-red-900">esta certificacion</span>
                    de forma permanente.
                </p>
            </div>

            <p data-certifications-delete-error class="hidden rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-700"></p>
